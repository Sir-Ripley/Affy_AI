...
class FirstOrdinalSerializer<T : Enum<T>>(private val enumClass: KClass<T>) : KSerializer<T> {
  ...
  private val cachedValues: Array<T> = enumClass.enumValues()
  private val nameToValue: Map<String, T> = cachedValues.associateBy { it.serialName }
  private val valueToName: Map<T, String> = cachedValues.associateWith { it.serialName }
